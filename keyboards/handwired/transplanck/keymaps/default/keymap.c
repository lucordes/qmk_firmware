...
[_LOWER] = LAYOUT_ortho_4x12(
  RESET, _______,  KC_WBAK,  KC_UP,  KC_WFWD,  TG(_AMONGUS),  _______,  KC_BTN1,  KC_MS_U,  KC_BTN2,    KC_LPRN,  KC_RPRN,
  ALTTAB, TABCYCLE,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_ENT , _______,  KC_MS_L,  KC_MS_D,  KC_MS_R,    KC_LCBR,  KC_RCBR,
  _______, _______, _______,  _______,  KC_BSPC,  _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  _______,      KC_LBRC,  KC_RBRC,
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  _______, _______, _______, _______, KC_MINUS, _______, _______, KC_EQUAL, KC_BSLASH, _______, KC_BSLS, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
